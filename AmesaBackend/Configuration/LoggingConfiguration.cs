...
{
    /// <summary>
    /// Configures Serilog logging for the Main backend service.
    /// </summary>
    public static IHostBuilder UseMainSerilog(this IHostBuilder hostBuilder, IConfiguration configuration)
    {
