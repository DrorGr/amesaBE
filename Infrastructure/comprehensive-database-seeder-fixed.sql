...
-- Clear existing data
TRUNCATE TABLE "UserPhones" CASCADE;
TRUNCATE TABLE "UserAddresses" CASCADE;
...
-- Clear existing data
TRUNCATE TABLE "HouseImages" CASCADE;
...
SELECT 'User addresses seeded: ' || COUNT(*)::text AS result FROM amesa_auth."UserAddresses";
SELECT 'User phones seeded: ' || COUNT(*)::text AS result FROM amesa_auth."UserPhones";
SELECT 'Houses seeded: ' || COUNT(*)::text AS result FROM public."Houses";
SELECT 'House images seeded: ' || COUNT(*)::text AS result FROM public."HouseImages";
