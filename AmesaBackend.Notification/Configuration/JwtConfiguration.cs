...
public static class JwtConfiguration
{
    ...
    /// </summary>
    public static AuthenticationBuilder AddNotificationJwtAuthentication(this IServiceCollection services, IConfiguration configuration, IHostEnvironment environment)
    {
