...
{
    /// <summary>
    /// Configures Serilog logging for the Notification service.
    /// </summary>
    public static IHostBuilder UseNotificationSerilog(this IHostBuilder hostBuilder, IConfiguration configuration)
    {
