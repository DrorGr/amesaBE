-- ============================================
-- COMPREHENSIVE DATABASE SEEDER SQL SCRIPT
-- Replicates the .NET DatabaseSeeder functionality
-- For AWS Query Editor execution
-- ============================================
...
-- ============================================
-- SCHEMA: amesa_content - Languages
-- ============================================
SET search_path TO amesa_content;

-- Clear existing languages
DELETE FROM "translations" WHERE 1=1;
DELETE FROM "Languages" WHERE 1=1;
...
-- ============================================
-- COMPREHENSIVE TRANSLATIONS (500+ entries)
-- ============================================

-- Navigation translations
INSERT INTO "translations" ("Id", "LanguageCode", "Key", "Value", "Description", "Category", "CreatedBy", "UpdatedBy", "CreatedAt", "UpdatedAt")
VALUES 
...
-- Clear existing data
DELETE FROM "UserPhones" WHERE 1=1;
DELETE FROM "UserAddresses" WHERE 1=1;
...
-- ============================================
-- SCHEMA: public - Houses and Related Data
-- ============================================
SET search_path TO public;

-- Clear existing data
DELETE FROM "HouseImages" WHERE 1=1;
DELETE FROM "Houses" WHERE 1=1;
...
BEGIN
    ...
    -- Insert Houses
    INSERT INTO "Houses" ("Id", "Title", "Description", "Price", "Location", "Address", "Bedrooms", "Bathrooms", "SquareFeet", "PropertyType", "YearBuilt", "LotSize", "Features", "Status", "TotalTickets", "TicketPrice", "LotteryStartDate", "LotteryEndDate", "DrawDate", "MinimumParticipationPercentage", "CreatedBy", "CreatedAt", "UpdatedAt")
    VALUES 
        ...
        (house6_id, 'Modern Penthouse in Wrocław', 'Stunning 4-bedroom penthouse with panoramic views of Wrocław''s Old Town and the Oder River. Features floor-to-ceiling windows and a private rooftop terrace.', 700000.00, 'Wrocław, Poland', '88 Rynek, Wrocław', 4, 3, 1800, 'Penthouse', 2023, 0.2, ARRAY['River View', 'Rooftop Terrace', 'Smart Home', 'Elevator', 'Parking', 'Concierge'], 1, 35000, 20.00, NOW() + INTERVAL '7 days', NOW() + INTERVAL '37 days', NOW() + INTERVAL '38 days', 85.00, admin_user_id, NOW() - INTERVAL '5 days', NOW() - INTERVAL '1 day'),
        ...
        (house8_id, 'Historic Mansion in Poznań', 'Magnificent 6-bedroom historic mansion in the heart of Poznań''s Old Town. Restored to perfection with original architectural details and modern amenities.', 1100000.00, 'Poznań, Poland', '3 Stary Rynek, Poznań', 6, 5, 4200, 'Historic Mansion', 1875, 0.4, ARRAY['Historic Architecture', 'Old Town Location', 'Garden', 'Terrace', 'Parking', 'Restored'], 1, 55000, 20.00, NOW() + INTERVAL '10 days', NOW() + INTERVAL '40 days', NOW() + INTERVAL '41 days', 70.00, admin_user_id, NOW() - INTERVAL '4 days', NOW() - INTERVAL '1 day');

    -- Insert House Images (5 images per house: 1 main + 4 small)
    INSERT INTO "HouseImages" ("Id", "HouseId", "ImageUrl", "AltText", "DisplayOrder", "IsPrimary", "MediaType", "FileSize", "Width", "Height", "CreatedAt")
    VALUES 
...
-- Show results
SELECT 'Languages seeded: ' || COUNT(*)::text FROM amesa_content."Languages";
SELECT 'Translations seeded: ' || COUNT(*)::text FROM amesa_content."translations";
SELECT 'Users seeded: ' || COUNT(*)::text FROM amesa_auth."Users";
SELECT 'User addresses seeded: ' || COUNT(*)::text FROM amesa_auth."UserAddresses";
SELECT 'User phones seeded: ' || COUNT(*)::text FROM amesa_auth."UserPhones";
SELECT 'Houses seeded: ' || COUNT(*)::text FROM public."Houses";
SELECT 'House images seeded: ' || COUNT(*)::text FROM public."HouseImages";
