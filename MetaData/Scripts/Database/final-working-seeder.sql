-- ============================================
-- FINAL WORKING DATABASE SEEDER - CORRECT COLUMN NAMES
-- Based on actual database structure with PascalCase columns
-- ============================================
...
-- Insert Languages (using PascalCase column names)
...
-- Insert comprehensive translations (using PascalCase column names)
...
-- Insert Users with proper password hashes (using PascalCase column names)
...
BEGIN
    ...
    INSERT INTO user_addresses ("Id", "UserId", "Type", "Country", "City", "Street", "HouseNumber", "ZipCode", "IsPrimary", "CreatedAt", "UpdatedAt")
    VALUES 
    ...
    -- Insert User Phones
    INSERT INTO user_phones ("Id", "UserId", "PhoneNumber", "IsPrimary", "IsVerified", "CreatedAt", "UpdatedAt")
    VALUES 
...
-- Get admin user ID for house creation (using PascalCase column names)
DO $$
DECLARE
    admin_user_id UUID;
...
BEGIN
    ...
    -- Insert Houses (using PascalCase column names)
    ...
    -- Insert House Images (5 images per house: 1 main + 4 small) (using PascalCase column names)
...
SELECT 'All data has been seeded across all schemas with correct PascalCase columns.' AS message;
