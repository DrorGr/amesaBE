...
{
    /// <summary>
    /// Configures Serilog logging for the Content service.
    /// </summary>
    public static IHostBuilder UseContentSerilog(this IHostBuilder hostBuilder, IConfiguration configuration)
    {
