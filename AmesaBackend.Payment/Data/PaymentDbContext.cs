    ...
    public class PaymentDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Transaction>(entity =>
            {
                ...
                entity.Property(e => e.ProviderTransactionId).HasMaxLength(255).HasColumnName("ProviderTransactionId");
                entity.Property(e => e.ProductId).HasColumnName("ProductId");
                entity.Property(e => e.IdempotencyKey).HasMaxLength(255).HasColumnName("IdempotencyKey");
                entity.Property(e => e.ClientSecret).HasMaxLength(255).HasColumnName("ClientSecret");
