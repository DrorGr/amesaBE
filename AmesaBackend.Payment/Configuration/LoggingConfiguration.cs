...
{
    /// <summary>
    /// Configures Serilog logging for the Payment service.
    /// </summary>
    public static IHostBuilder UsePaymentSerilog(this IHostBuilder hostBuilder, IConfiguration configuration)
    {
