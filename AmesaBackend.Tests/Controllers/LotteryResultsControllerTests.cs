...
{
    public class LotteryResultsControllerTests : IClassFixture<WebApplicationFactory<MainProgram>>, IDisposable
    {
        ...
        public LotteryResultsControllerTests(WebApplicationFactory<MainProgram> factory)
        {
